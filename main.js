    ...
    data () {
        return {
            portfolioList: [
                ...
                {projectName: 'Malaysia Covid-19 Case Dashboard', projectDesc: 'A Vue application that show updated daily confirmed, death, recovered Covid-19 cases in Malaysia. Data sources are get from JHU CSSE. Hosted on GitHub pages.', projectUrl: 'https://luisychun.github.io/malaysia-covid19-local-case/', projectStack: ['fab fa-html5 fa-2x', 'fab fa-css3-alt fa-2x', 'fab fa-vuejs fa-2x'], projectImprovement: ''},

                {projectName: 'Personal Knowledge Base', projectDesc: 'A static website that uses to collect my personal wiki. Build with static site generator called Hugo and a UI framework Semantic UI. All the notes are written in Markdown format. Hosted on Netlify.', projectUrl: 'https://compassionate-euler-7bd6b0.netlify.app/', projectStack: ['fab fa-html5 fa-2x', 'fab fa-css3-alt fa-2x', 'fab fa-markdown fa-2x'], projectImprovement: ''},

                {projectName: 'BorneoStar Automobile Malaysia', projectDesc: 'Customer from the luxury car repair shop requests a static website to display the company products, and services to lead a potential customer to reach their business.', projectUrl: 'https://borneostarauto.com/', projectStack: ['fab fa-html5 fa-2x', 'fab fa-css3-alt fa-2x', 'fab fa-vuejs fa-2x'], projectImprovement: ''},
